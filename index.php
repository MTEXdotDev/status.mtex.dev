    ...
    <div class="max-w-5xl mx-auto px-4 py-8 md:px-6 md:py-12">
        <header class="sticky top-0 z-50 mb-8 md:mb-16 pt-4 pb-6 glass-header border-b border-neutral-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <a href="https://github.com/MTEDdotDev/status.mtex.dev" target="_blank" class="flex-1 md:flex-none flex justify-center items-center p-2.5 bg-neutral-900 border border-neutral-800 rounded-xl text-neutral-400 hover:text-white hover:border-neutral-700 transition-all shadow-sm" title="View Source">
